...
public class MyController {
    ...
    //Petició Get qye retorna el llistat de partides d'un jugador amb l'id indicat al path
    @GetMapping("/{id}/games/")
    public List<RoundResponseDto> getAllRoundsByPlayer(@PathVariable String id) {
    	List<RoundResponseDto> rounds = playerService.getAllRoundsByIdPlayer(Integer.parseInt(id));
    	return rounds;
    }
    ...
    public RoundResponseDto newRoundByPlayer(@PathVariable String id) {
         RoundResponseDto newRound =playerService.newRound(Integer.parseInt(id));
    	 return newRound;
    }
    ...
    public void deleteAllRounds(@PathVariable String id) {
    	playerService.deleteAllRoundsByPlayerId(Integer.parseInt(id));
    }
